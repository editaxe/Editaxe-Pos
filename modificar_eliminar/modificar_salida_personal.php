...
$cod_salida_personal = intval($_POST['cod_salida_personal']);

$sql_data = sprintf("UPDATE salida_personal SET conceptos = '$conceptos', costo = '$costo', comentarios = '$comentarios', nombre_ccosto = '$nombre_ccosto', 
fecha_dmy = '$fecha_dmy', fecha_mes = '$fecha_mes', anyo = '$anyo', fecha_seg = '$fecha_seg' WHERE cod_salida_personal = '$cod_salida_personal'");
...
$sql_modificar_consulta = "SELECT * FROM salida_personal WHERE cod_salida_personal = '$cod_salida_personal'";
...
<body>
<?php
if (isset($_GET["cod_salida_personal"])) {
?>
<center>
...
<input type="hidden" name="cod_salida_personal" value="<?php echo $datos['cod_salida_personal']; ?>">
</form>
</center>
<?php
}
