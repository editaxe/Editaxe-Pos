...
if ((isset($_GET['cod_entrada_personal'])) && ($_GET['cod_entrada_personal'] != "")) {

$cod_entrada_personal = intval($_GET['cod_entrada_personal']);
$fecha = addslashes($_GET['fecha']);
$pagina = $_GET['pagina'].'?fecha='.$fecha;

$sql_data = sprintf("DELETE FROM entrada_personal WHERE cod_entrada_personal = '$cod_entrada_personal'");
