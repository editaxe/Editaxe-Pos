 ...
 */
 ...
 class pImage extends pDraw
   ...
   */
   ...
   var $FontSize          = 15;				// Default font size
   var $FontBox           = NULL;			// Return the bounding box of the last written string
   var $FontColorR        = F;				// Default color settings
   var $FontColorG        = F;				// Default color settings
   var $FontColorB        = F;				// Default color settings
