...
Sum(unidades_faltantes * precio_compra) As tot_precio_compra FROM productos";
...
<td align="center">TOTAL COSTO (PROYEC)</td>
...
<td align="center">MET <br><a href="../admin/inventario_productos.php?campo=detalles&ord=asc"><img src=../imagenes/asc.png alt="asc"></a></td>
...
<td align="center">MET <br><a href="../admin/inventario_productos.php?campo=detalles&ord=desc"><img src=../imagenes/desc.png alt="desc"></a></td>
