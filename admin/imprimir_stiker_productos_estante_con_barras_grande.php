...
$codigoHTML.='<td align="center" width="200px" height="200px" cellspacing="1" cellpadding="1"><font size="7" color="red">'.$nombre_productos.'</font>&nbsp;&nbsp;<br>
<font size="5" color="red"><strong>'.$cod_productos.'</strong></font><br>
<font size="3" color="red">PRECIO DE VENTA: </font><font size="7" color="red"><strong>'.number_format($precio_venta, 0, ",", ".").'</strong></font></td>';
} else { 
$estandar_barras = "C39"; 

$codigoHTML.='<td align="center" width="200px" height="200px" cellspacing="1" cellpadding="1"><font size="5" color="red">'.$nombre_productos.'</font>&nbsp;&nbsp;<br>
<font size="3" color="red"><strong>'.$cod_productos.'</strong></font><br>
<font size="3" color="red">PRECIO DE VENTA: </font><font size="6" color="red"><strong>'.number_format($precio_venta, 0, ",", ".").'</strong></font></td>';
}
