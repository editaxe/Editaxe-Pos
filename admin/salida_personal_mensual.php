...
$mostrar_datos_sql = "SELECT * FROM salida_personal WHERE fecha_mes = '$fecha' order by fecha_seg DESC";
$consulta = mysql_query($mostrar_datos_sql, $conectar) or die(mysql_error());
$datos = mysql_fetch_assoc($consulta);

$datos_sql_salida = "SELECT SUM(costo) AS costo FROM salida_personal WHERE fecha_mes = '$fecha' order by fecha_seg DESC";
...
$datos_sql_entrada = "SELECT SUM(costo) AS costo FROM entrada_personal WHERE fecha_mes = '$fecha' order by fecha_seg DESC";
...
<?php $sql_consulta = "SELECT fecha_mes FROM salida_personal GROUP BY fecha_mes DESC";
...
<td ><a href="../modificar_eliminar/.php?cod_salida_personal=<?php echo $cod_salida_personal?>&fecha=<?php echo $fecha?>&pagina=<?php echo $pagina?>"><center><img src=../imagenes/actualizar.png alt="Actualizar"></center></a></td>
</tr>
