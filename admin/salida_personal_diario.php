...
$mostrar_datos_sql = "SELECT * FROM salida_personal WHERE fecha_dmy = '$fecha' order by fecha_seg DESC";
...
<?php $sql_consulta = "SELECT fecha_dmy FROM salida_personal GROUP BY fecha_seg ORDER BY fecha_seg DESC";
