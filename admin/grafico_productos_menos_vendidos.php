...
$(function () {
    $('#container').highcharts({
        ...
        xAxis: {
            categories: [
<?php
$sql = "SELECT SUM(unidades_vendidas) AS unidades_vendidas, cod_productos, nombre_productos FROM ventas GROUP BY cod_productos ORDER BY unidades_vendidas ASC LIMIT 0,100";
