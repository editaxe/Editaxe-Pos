...
$cod_cargar_transferencias_temporal = $_POST['cod_cargar_transferencias_temporal'][$i];

$sql_mconsulta = "SELECT * FROM cargar_transferencias_temporal WHERE cod_cargar_transferencias_temporal = '$cod_cargar_transferencias_temporal'";
...
$actualiza_productos = sprintf("UPDATE productos SET unidades_faltantes = '$unidades_faltante', 
