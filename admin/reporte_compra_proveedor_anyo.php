...
FROM proveedores RIGHT JOIN facturas_cargadas_inv ON proveedores.cod_proveedores = facturas_cargadas_inv.cod_proveedores
WHERE ((facturas_cargadas_inv.anyo)='$fecha')";
...
<br>
<table align="center">
<td nowrap align="right"><font color='yellow' size='+3'>REPORTE COMPRAS PROVEEDORES ANUAL</font><br></td>
</table>
...
$consulta2_sql = "SELECT anyo FROM facturas_cargadas_inv GROUP BY anyo ORDER BY anyo DESC";
...
<center>
<fieldset><legend><font color='yellow' size='+3'>TOTAL COMPRAS A&Ntilde;O: <?php echo $fecha?></font></legend>
<table width='100%'>
...
<center>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="../admin/reporte_compra_proveedor_anyo_xlsx.php?fecha=<?php echo $fecha?>" target="_blank"><img src=../imagenes/excel.png alt="imprimir"></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="../admin/imprimir_datos_compras_agrupado_anyo_proveedor_pequena.php?fecha=<?php echo $fecha?>&campo=<?php echo $campo?>" target="_blank"><img src=../imagenes/imprimir_1.png alt="imprimir"></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
</table>
</fieldset>
<br>
<fieldset><legend><font color='yellow' size='+3'>COMPRAS A&Ntilde;O: <?php echo $fecha?></font></legend>
