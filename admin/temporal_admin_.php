...
<?php if ($detalles == 'PV1') { ?> 
<td id="tipo_precio_venta_<?php echo $cod_temporal;?>" align='center'><a href="../admin/actualizar_precio_venta.php?tipo_precio_venta=PV2&cod_temporal=<?php echo $cod_temporal?>&pagina=<?php echo $pagina?>"><img src="../imagenes/PV1.png" alt="Precio venta"></a></td> 
<?php } 
elseif ($detalles == 'PV2') {?>
<td id="tipo_precio_venta_<?php echo $cod_temporal;?>" align='center'><a href="../admin/actualizar_precio_venta.php?tipo_precio_venta=PV3&cod_temporal=<?php echo $cod_temporal?>&pagina=<?php echo $pagina?>"><img src="../imagenes/PV2.png" alt="Precio descuento"></a></td> 
<?php }
elseif ($detalles == 'PV3') {?>
<td id="tipo_precio_venta_<?php echo $cod_temporal;?>" align='center'><a href="../admin/actualizar_precio_venta.php?tipo_precio_venta=PV4&cod_temporal=<?php echo $cod_temporal?>&pagina=<?php echo $pagina?>"><img src="../imagenes/PV3.png" alt="Precio por mayor"></a></td> 
<?php }
elseif ($detalles == 'PV4') {?>
<td id="tipo_precio_venta_<?php echo $cod_temporal;?>" align='center'><a href="../admin/actualizar_precio_venta.php?tipo_precio_venta=PV1&cod_temporal=<?php echo $cod_temporal?>&pagina=<?php echo $pagina?>"><img src="../imagenes/PV4.png" alt="Precio por mayor"></a></td> 
<?php } ?>

<?php if ($detalles == 'PVAR') { ?>
<td id="PVAR_<?php echo $cod_temporal;?>" align='center'><img src="../imagenes/PVAR.png" alt="Precio variable"></a></td> 
<td id="precio_venta_<?php echo $cod_temporal;?>" align='center'><input onFocus="Focus(this.id, this.value)" onChange="calc_total_venta();" onBlur="Blur(this.id, this.value, 'precio_venta', <?php echo $cod_temporal;?>)" class="cajvtotal" id="precio_venta<?php echo $incre;?>" value="<?php echo $precio_venta;?>"></td>
<?php } 
else { ?>
<td id="precio_venta_no_modif_<?php echo $cod_temporal;?>" style="text-align:center; font-size:30;" align='right'><?php echo number_format($precio_venta, 0, ",", ".");?></td>
<?php } ?>
    ...
    $('.eliminar').click(function(){
        ...
        $.ajax({
            ...
            success: function() {           
                ...
                $('#mensaje_alerta_'+cod_temporal).fadeOut("slow");
