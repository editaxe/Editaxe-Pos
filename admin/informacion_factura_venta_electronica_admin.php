...
<input type="text" style="text-align:center; font-size:18px" name="numero_factura" onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'numero_factura', <?php echo $cod_info_impuesto_facturas;?>)" id="numero_factura" value="<?php echo $cod_factura ?>" size="7">
</td>

<td style="text-align:center;"><strong>FECHA VENTA: </strong><input style="text-align:center; font-size:18px" name="fecha_anyo" onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'fecha_anyo', <?php echo $cod_info_impuesto_facturas;?>)" id="fecha_anyo" value="<?php echo $fecha_anyo ?>" size="10" required></td>

<td style="text-align:center;"><strong>FECHA PAGO: </strong>
<input type="text" style="font-size:18px" tabindex=3 name="fecha_pago" id="fecha_pago" value="<?php echo  date("d/m/Y")?>" size="10" required autofocus></td>
...
<select name="tipo_pago" id="tipo_pago" style="text-align:center; font-size:18px" class="selectpicker" data-show-subtext="true" data-live-search="true">
...
<td style="text-align:center; font-size:30;" id="total_venta"><?php echo number_format($matriz_temporal['total_venta'], 0, ",", "."); ?></td>

<td style="text-align:center;"><strong>RECIBIDO: </strong><input type="text" style="font-size:28px" name="vlr_cancelado" value="" size="8" required autofocus></td>
...
<?php } ?>
<?php
$pagina ='factura_eletronica_admin.php'
?>
