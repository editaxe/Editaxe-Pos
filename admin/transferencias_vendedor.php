...
?>
<tr>
<td><a href="../modificar_eliminar/eliminar_cargar_transferencias_temporal2.php?cod_productos=<?php echo $datos['cod_productos']?>&cod_cargar_transferencias_temporal2=<?php echo $datos['cod_cargar_transferencias_temporal2']?>" tabindex=3><center><img src=../imagenes/eliminar.png alt="eliminar"></center></a></td>
<td><?php echo $cod_productos;?></td>
<td><?php echo $nombre_productos;?></td>
<td align="center"><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'cajas', <?php echo $cod_productos;?>)" class="cajund" id="<?php echo $cod_productos;?>" value="<?php echo $cajas;?>" size="3"></td>
<td align="center"><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'unidades', <?php echo $cod_productos;?>)" class="cajund" id="<?php echo $cod_productos;?>" value="<?php echo $unidades;?>" size="3"></td>
<td><div align='center'><?php echo $unidades_total;?></div></td>
<td><div align='right'><?php echo $precio_venta;?></div></td>
