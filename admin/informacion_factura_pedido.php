...
sum(vlr_total_venta) as vlr_total_venta, sum(valor_iva) as valor_iva , sum(precio_costo) as precio_costo FROM pedidos_temporal WHERE vendedor = '$cuenta_actual'";
$consulta_suma = mysql_query($suma_factura, $conectar) or die(mysql_error());
$suma = mysql_fetch_assoc($consulta_suma);
?>
<center>
<table id="table" width="100%">
<form method="post" name="formulario" action="../admin/guardar_factura_pedidos.php">
