...
$codigoHTML.='<td align="center" width="200px" height="110px" cellspacing="1" cellpadding="1"><font size="5" color="black">'.$nombre_productos.'</font><br>
<font size="3" color="black">COD: </font><font size="3" color="black"><strong>'.$cod_productos.'</strong></font><br>
<font size="3" color="black">PRECIO DE VENTA: </font><font size="7" color="black"><strong>'.number_format($precio_venta, 0, ",", ".").'</strong></font></td>';
}
}
