...
$cod_stiker_productos_estante = intval($_GET['id']);

$sql_modificar_consulta = "SELECT * FROM stiker_productos_estante WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'";
...
mysql_query("UPDATE stiker_productos_estante SET unidades_total = '$unidades_total' WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}

if ($campo == 'cod_factura') {
$cod_factura = $valor_intro;
mysql_query("UPDATE stiker_productos_estante SET cod_factura = '$cod_factura' WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
...
mysql_query("UPDATE stiker_productos_estante SET cajas = '$cajas', unidades_vendidas = '$unidades_vendidas', unidades_total = '$unidades_total',
...
vlr_total_compra = '$vlr_total_compra' WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
//PARA UNIDADES
if ($campo == 'unidades') {
...
mysql_query("UPDATE stiker_productos_estante SET unidades = '$unidades', unidades_vendidas = '$unidades_vendidas', unidades_total = '$unidades_total',
precio_costo = '$precio_costo', valor_iva = '$valor_iva', precio_compra_con_descuento = '$precio_compra_con_descuento', descuento = '$descuento', 
vlr_total_compra = '$vlr_total_compra' WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
//PARA PRECIO COMPRA
...
mysql_query("UPDATE stiker_productos_estante SET precio_compra = '$precio_compra', precio_costo = '$precio_costo', valor_iva = '$valor_iva', 
precio_compra_con_descuento = '$precio_compra_con_descuento', vlr_total_compra = '$vlr_total_compra', descuento = '$descuento', 
fecha_mes = '$descripcion' WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
//PARA IVA
if ($campo == 'iva') {
$iva = $valor_intro;	
...
mysql_query("UPDATE stiker_productos_estante SET iva = '$iva', valor_iva = '$valor_iva', precio_compra_con_descuento = '$precio_compra_con_descuento',
precio_costo = '$precio_costo', vlr_total_compra = '$vlr_total_compra', descuento = '$descuento' 
WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
...
mysql_query("UPDATE stiker_productos_estante SET precio_venta = '$precio_venta', fecha_mes = '$descripcion' 
WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
...
mysql_query("UPDATE stiker_productos_estante SET precio_venta2 = '$precio_venta2', fecha_mes = '$descripcion' 
WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
...
mysql_query("UPDATE stiker_productos_estante SET precio_venta3 = '$precio_venta3', fecha_mes = '$descripcion' 
WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
...
mysql_query("UPDATE stiker_productos_estante SET precio_venta4 = '$precio_venta4', fecha_mes = '$descripcion' 
WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
...
mysql_query("UPDATE stiker_productos_estante SET precio_venta5 = '$precio_venta5', fecha_mes = '$descripcion' 
WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
...
mysql_query("UPDATE stiker_productos_estante SET vlr_total_venta = '$vlr_total_venta', precio_venta = '$precio_venta', fecha_mes = '$descripcion' 
WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
...
mysql_query("UPDATE stiker_productos_estante SET ptj_ganancia = '$ptj_ganancia', vlr_total_venta = '$vlr_total_venta', precio_venta = '$precio_venta' 
WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
//PARA DTO1
if ($campo == 'dto1') {
...
mysql_query("UPDATE stiker_productos_estante SET dto1 = '$dto1', precio_compra_con_descuento = '$precio_compra_con_descuento', precio_costo = '$precio_costo', 
vlr_total_compra = '$vlr_total_compra', descuento = '$descuento' WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
//PARA DTO2
if ($campo == 'dto2') {
$dto2 = $valor_intro;
...
mysql_query("UPDATE stiker_productos_estante SET dto2 = '$dto2', precio_compra_con_descuento = '$precio_compra_con_descuento', precio_costo = '$precio_costo', 
vlr_total_compra = '$vlr_total_compra', descuento = '$descuento' WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
//PARA PORCENTAJE VENDEDOR
if ($campo == 'porcentaje_vendedor') {
$porcentaje_vendedor = $valor_intro;
mysql_query("UPDATE stiker_productos_estante SET porcentaje_vendedor = '$porcentaje_vendedor' WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
...
mysql_query("UPDATE stiker_productos_estante SET fechas_vencimiento = '$fechas_vencimiento', fechas_vencimiento_seg = '$fecha_recibida_segundos' 
WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
//PARA TOPE MINIMO
if ($campo == 'tope_min') {
$tope_min = $valor_intro;
mysql_query("UPDATE stiker_productos_estante SET tope_min = '$tope_min' WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
//PARA DETALLES
if ($campo == 'detalles') {
$detalles = $valor_intro;
mysql_query("UPDATE stiker_productos_estante SET detalles = '$detalles' WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
//PARA IVA VALOR
if ($campo == 'iva_v') {
$iva_v = $valor_intro;
mysql_query("UPDATE stiker_productos_estante SET iva_v = '$iva_v' WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
//PARA NOMRE PRODUCTOS
if ($campo == 'nombre_productos') {
$nombre_productos = $valor_intro;
mysql_query("UPDATE stiker_productos_estante SET nombre_productos = '$nombre_productos' WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
//PARA CODIGO ORIGINAL
if ($campo == 'cod_original') {
$cod_original = $valor_intro;
mysql_query("UPDATE stiker_productos_estante SET cod_original = '$cod_original' WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
//PARA CODIFICACION
if ($campo == 'codificacion') {
$codificacion = $valor_intro;
mysql_query("UPDATE stiker_productos_estante SET codificacion = '$codificacion' WHERE cod_stiker_productos_estante = '$cod_stiker_productos_estante'", $conectar);
}
}
?>