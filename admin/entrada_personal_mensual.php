...
$mostrar_datos_sql = "SELECT * FROM entrada_personal WHERE fecha_mes = '$fecha' order by fecha_seg DESC";
...
<?php $sql_consulta = "SELECT fecha_mes FROM entrada_personal GROUP BY fecha_mes ORDER BY fecha_seg DESC";
