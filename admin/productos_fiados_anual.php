...
<table align="center">
<td nowrap align="right">POR COBRAR ANUAL:</td>
<td bordercolor="0">
<select name="fecha" id="foco">
<?php $sql_consulta1 = "SELECT anyo FROM productos_fiados GROUP BY anyo DESC";
...
AND productos_fiados.anyo = '$fecha' ORDER BY fecha DESC";
