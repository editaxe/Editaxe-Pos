...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A'.$increment, $vendedor)
            ->setCellValue('B'.$increment, round($total_venta_contado, 0))
            ->setCellValue('C'.$increment, $fecha_inicial)
            ->setCellValue('D'.$increment, $fecha_final);
}
// Rename worksheet
...
$nombre_archivo = 'reporte_ventas_vendedores_de_'.$fecha_inicial.'_a_'.$fecha_final;
