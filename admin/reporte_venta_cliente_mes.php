...
clientes.nombres, clientes.apellidos, clientes.cedula, ventas.vlr_total_venta, ventas.iva, ventas.fecha_mes, ventas.cod_clientes 
...
<br>
<table align="center">
<td nowrap align="right"><font color='yellow' size='+3'>REPORTE VENTAS CLIENTE MENSUAL</font><br></td>
</table>
...
$consulta2_sql = "SELECT fecha_mes FROM ventas GROUP BY fecha_mes ORDER BY fecha DESC";
...
<center>
<fieldset><legend><font color='yellow' size='+3'>TOTAL VENTAS MES: <?php echo $fecha?></font></legend>
<table width='100%'>
...
<center>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="../admin/reporte_venta_cliente_fechas_mes_xlsx.php?fecha=<?php echo $fecha?>" target="_blank"><img src=../imagenes/excel.png alt="imprimir"></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<br>
<fieldset><legend><font color='yellow' size='+3'>VENTAS MES: <?php echo $fecha?></font></legend>
...
<br>
<fieldset><legend><font color='yellow' size='+3'>ABONOS MES: <?php echo $fecha?></font></legend>
<table align="center" width='50%'>
<tr>
<td align="center"><strong>NIT</strong></td>
<td align="center"><strong>CLIENTE</strong></td>
