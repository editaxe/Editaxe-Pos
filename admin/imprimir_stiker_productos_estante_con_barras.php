...
$codigoHTML.='<td align="center" width="200px" height="110px" cellspacing="1" cellpadding="1"><font size="5" color="red">'.$nombre_productos.'</font>&nbsp;&nbsp;<br>
<barcode code="'.$cod_productos.'" type="'.$estandar_barras.'"  size="1" height="0.6"/><br>
...
$codigoHTML.='<td align="center" width="200px" height="110px" cellspacing="1" cellpadding="1"><font size="5" color="red">'.$nombre_productos.'</font>&nbsp;&nbsp;<br>
<barcode code="'.$cod_productos.'" type="'.$estandar_barras.'"  size="1.5" height="0.6"/><br>
<font size="3" color="red"><strong>'.$cod_productos.'</strong></font><br>
<font size="3" color="red">PRECIO DE VENTA: </font><font size="6" color="red"><strong>'.number_format($precio_venta, 0, ",", ".").'</strong></font></td>';
}
