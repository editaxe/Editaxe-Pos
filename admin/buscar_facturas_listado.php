...
<td align="right"><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'unidades_vendidas', <?php echo $cod_ventas;?>)" class="cajgrande" id="b<?php echo $cod_ventas;?>" value="<?php echo $unidades_vendidas;?>" size="3"></td>
<?php 
    if ($detalles == 'PV1') { ?> <td id="tipo_precio_venta<?php echo $cod_ventas;?>" align='center'><a href="../admin/actualizar_precio_venta_facturado.php?tipo_precio_venta=PV2&cod_ventas=<?php echo $cod_ventas?>&pagina=<?php echo $pagina?>"><img src="../imagenes/PV1.png" alt="Precio venta"></a></td> <?php } 
...
elseif ($detalles == 'PV3') { ?> <td id="tipo_precio_venta<?php echo $cod_ventas;?>" align='center'><a href="../admin/actualizar_precio_venta_facturado.php?tipo_precio_venta=PV4&cod_ventas=<?php echo $cod_ventas?>&pagina=<?php echo $pagina?>"><img src="../imagenes/PV3.png" alt="Precio por mayor"></a></td> <?php } 
elseif ($detalles == 'PV4') { ?> <td id="tipo_precio_venta<?php echo $cod_ventas;?>" align='center'><a href="../admin/actualizar_precio_venta_facturado.php?tipo_precio_venta=PV1&cod_ventas=<?php echo $cod_ventas?>&pagina=<?php echo $pagina?>"><img src="../imagenes/PV4.png" alt="Precio por mayor"></a></td> <?php } 

elseif ($detalles == 'PVAR') { ?> <td id="tipo_precio_venta<?php echo $cod_ventas;?>" align='center'><a href=""><img src="../imagenes/PVAR.png" alt="Precio por mayor"></a></td> <?php } 

if ($detalles == 'PVAR') { ?> <td align='right'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'precio_venta', <?php echo $cod_ventas;?>)" class="cajgrande" id="<?php echo $cod_ventas;?>" value="<?php echo $precio_venta;?>" size="9"></td> <?php } 
...
<table border="0" width="98%" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  ...
  <tr>
    <td style="text-align: center; width: 98%; font-family: Courier; font-size:8pt;"><strong><?php echo $fecha.$hora.'-'.$cod_factura.'-'.$fecha_venta_ymd.$hora_venta_his ?></strong>_ls_si_eit</td>
  </tr>
</table>
