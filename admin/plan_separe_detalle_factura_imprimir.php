...
<title>'."Plan Separe Abonos Factura: ".$cod_clientes.'</title>
</head>
<body>
...
<tr>
<td align="center"><strong><p style="font-size:30px">PLAN SEPARE ABONOS (POR FACTURA)</p></strong></td>
</tr>
</table>
...
<td align="center"><strong><p style="font-size:30px">ABONO</p></strong></td>
<td align="center"><strong><p style="font-size:30px">FECHA</p></strong></td>
<td align="center"><strong><p style="font-size:30px">PAGO A</p></strong></td>
</tr>
<tr>
<td align="center" colspan="5">================================</td>
</tr>
';
$sql_monto_deuda = "SELECT total_plan_separe, total_abono_plan_separe, total_saldo_plan_separe FROM plan_separe WHERE cod_plan_separe = '$cod_plan_separe'";
...
$total_abono_plan_separe      = $sum_monto_deuda['total_abono_plan_separe'];
$total_saldo_plan_separe      = $total_plan_separe - $total_abono_plan_separe;

$calcular_datos_plan_separe = "SELECT * FROM plan_separe_abono WHERE cod_plan_separe='$cod_plan_separe' ORDER BY fecha_invert DESC";
...
$abono_plan_separe           = $datos_cuenta_cobrar['abono_plan_separe'];
$fecha_anyo                  = $datos_cuenta_cobrar['fecha_anyo'];
$vendedor                    = $datos_cuenta_cobrar['vendedor'];
$codigoHTML.='
<tr>
<td align="center"><p style="font-size:30px"><strong>'.$cod_plan_separe.'</strong></p></td>
<td align="right"><p style="font-size:30px"><strong>'.number_format($abono_plan_separe, 0, ",", ".").'</strong></p></td>
<td align="right"><p style="font-size:30px"><strong>'.$fecha_anyo.'</strong></p></td>
<td align="right"><p style="font-size:30px"><strong>'.$vendedor.'</strong></p></td>
</tr>';
} 
$codigoHTML.='
</table>
...
<td align="right"><strong><p style="font-size:40px">'.number_format($total_plan_separe, 0, ",", ".").'</p></strong></td>
</tr>
<tr>
<td align="center"><strong><p style="font-size:40px">TOTAL ABONADO</strong></td>
<td align="right"><strong><p style="font-size:40px">'.number_format($total_abono_plan_separe, 0, ",", ".").'</p></strong></td>
</tr>
<tr>
<td align="center"><strong><p style="font-size:40px">SALDO PENDIENTE</strong></td>
<td align="right"><strong><p style="font-size:40px">'.number_format($total_saldo_plan_separe, 0, ",", ".").'</p></strong></td>
</tr>
</table>
