...
$cod_factura_temp = intval($_POST['cod_factura_temp']);
...
$cod_transferencias2 = $_POST['cod_transferencias2'][$i];

$sql_mconsulta = "SELECT * FROM transferencias2 WHERE cod_transferencias2 = '$cod_transferencias2'";
