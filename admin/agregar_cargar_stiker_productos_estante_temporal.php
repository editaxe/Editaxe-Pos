...
//--------------------------------------------------------------------//
if (isset($cod_productos_var) && $cod_productos_var <> NULL) {

$reg_factura_temp = "INSERT INTO stiker_productos_estante_temporal (cod_productos, nombre_productos, cod_original, codificacion, unidades_total, 
unidades, cajas, precio_compra, precio_venta, precio_venta2, precio_venta3, precio_venta4, precio_venta5, precio_costo, vlr_total_venta, 
vlr_total_compra, precio_compra_con_descuento, detalles, tope_min, vendedor, ip, fecha, fecha_mes, fechas_vencimiento, fechas_vencimiento_seg, 
...
'$unidades', '$cajas', '$precio_compra', '$precio_venta', '$precio_venta2', '$precio_venta3', '$precio_venta4', '$precio_venta5', '$precio_compra', '$vlr_total_venta', 
'$vlr_total_compra', '$precio_compra_con_descuento', '$detalles', '$tope_min', '$vendedor', '$ip', '$fecha', '$fecha_mes', '$fechas_vencimiento', '$fechas_vencimiento_seg', 
'$dto1', '$dto2', '$iva', '$valor_iva', '$ptj_ganancia', '$porcentaje_vendedor', '$fecha_anyo', '$fecha_hora')";
