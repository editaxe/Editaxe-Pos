...
<body>
<?php
$pagina = 'cargar_stiker_productos_estante_temporal.php';
...
<td align="left" ><a href="../admin/agregar_cargar_stiker_productos_estante_temporal.php?cod_productos_var=<?php echo $cod_productos_var; ?>&pagina=<?php echo $pagina; ?>"><?php echo utf8_encode($nombre_productos); ?></a></td>
