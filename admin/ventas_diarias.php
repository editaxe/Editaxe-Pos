...
$mostrar_datos_sql = "SELECT * FROM dependencia RIGHT JOIN ventas ON dependencia.cod_dependencia = ventas.cod_dependencia WHERE ventas.fecha_anyo = '$fecha' ORDER BY ventas.cod_ventas DESC";
...
$mostrar_datos_sql_productos = "SELECT  Sum(precio_compra * unidades_faltantes) As total_mercancia, 
