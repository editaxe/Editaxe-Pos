...
$data_sql = ("UPDATE info_impuesto_facturas SET cod_clientes = '$cod_clientes' WHERE cod_info_impuesto_facturas = '$cod_info_impuesto_facturas'");
...
$data_sql = ("UPDATE info_impuesto_facturas SET descuento = '$descuento' WHERE cod_info_impuesto_facturas = '$cod_info_impuesto_facturas'");
$exec_data = mysql_query($data_sql, $conectar) or die(mysql_error());
...
$data_sql = ("UPDATE info_impuesto_facturas SET tipo_pago = '$tipo_pago' WHERE cod_info_impuesto_facturas = '$cod_info_impuesto_facturas'");
$exec_data = mysql_query($data_sql, $conectar) or die(mysql_error());
...
$data_sql = ("UPDATE info_impuesto_facturas SET bolsa = '$bolsa' WHERE cod_info_impuesto_facturas = '$cod_info_impuesto_facturas'");
$exec_data = mysql_query($data_sql, $conectar) or die(mysql_error());
}
