...
<table align="center">
<td nowrap align="right">POR COBRAR MENSUAL:</td>
<td bordercolor="0">
<select name="fecha" id="foco">
<?php $sql_consulta1 = "SELECT fecha, fecha_mes FROM productos_fiados GROUP BY fecha_mes ORDER BY fecha DESC";
...
AND productos_fiados.fecha_mes = '$fecha' ORDER BY fecha DESC";
