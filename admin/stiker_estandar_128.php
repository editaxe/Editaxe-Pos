...
<?php $sql_consulta1="SELECT DISTINCT fechas_dia, fechas_anyo FROM productos ORDER BY fechas_dia DESC";
$resultado = mysql_query($sql_consulta1, $conectar) or die(mysql_error());
while ($contenedor=mysql_fetch_array($resultado)) {?>
<option value="<?php echo $contenedor['fechas_dia'] ?>"><?php echo $contenedor['fechas_anyo'] ?></option>
<?php }?>
</select></td>
<tr valign="baseline">
